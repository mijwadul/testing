...
class Employee(Base):
    ...
    employment_type = Column(String, default="permanent")  # permanent, contract, freelance
    ...
    loan_deduction_per_period = Column(Float, default=0)  # Potongan per periode (hari/minggu/bulan)
    debt_to_company = Column(Float, default=0)  # Hutang karyawan ke perusahaan (kecelakaan, dll)
    ...
    # Linked User Account
    user_id = Column(Integer, nullable=True)  # Link ke tabel users
